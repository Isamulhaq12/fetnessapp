...
import 'crescent _low _lunge _left.dart';
import 'half_ locust_ pose.dart';
...
class _Day1ScreenState extends State<Day1Screen> {
          ...
          Padding(
            ...
            child: MyButton(
              ...
              circularRadius: BorderRadius.circular(25),
                ...
                onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => const DownwardScreen(),));
                },
                text: 'Start',
              fontSize: 18,
            ),
  ...
  List<dynamic> day1 =[
    ...
    DayModel(
        upText: "Downward Facing Dog with Bent\nKnees",
        downText: "00:60",
        image: const AssetImage(dfd)
    ),
    DayModel(
        upText: "",
        downText: "",
