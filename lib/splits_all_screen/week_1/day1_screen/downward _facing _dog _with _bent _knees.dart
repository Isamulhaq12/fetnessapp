...
class DownwardScreen extends StatefulWidget {
  const DownwardScreen({super.key});

  @override
  State<DownwardScreen> createState() => _DownwardScreenState();
}

class _DownwardScreenState extends State<DownwardScreen> {
  int min = 00;
  int second = 00;
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Image.asset(dfd, fit: BoxFit.cover),
            ),
            const SizedBox(
              height: 10,
            ),
