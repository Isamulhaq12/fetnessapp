...
class HalfLocustScreen extends StatefulWidget {
  const HalfLocustScreen({super.key});

  @override
  State<HalfLocustScreen> createState() => _HalfLocustScreenState();
}

class _HalfLocustScreenState extends State<HalfLocustScreen> {
  int min = 00;
  int second = 00;
