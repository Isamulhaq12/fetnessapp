...
class ArmRaisesScreen extends StatefulWidget {
  const ArmRaisesScreen({super.key});

  @override
  State<ArmRaisesScreen> createState() => _ArmRaisesScreenState();
}

class _ArmRaisesScreenState extends State<ArmRaisesScreen> {
  int min = 00;
  int second = 00;
