...
class HalfLocustPoseScreen extends StatefulWidget {
  const HalfLocustPoseScreen({super.key});

  @override
  State<HalfLocustPoseScreen> createState() => _HalfLocustPoseScreenState();
}

class _HalfLocustPoseScreenState extends State<HalfLocustPoseScreen> {
  int min = 00;
  int second = 00;
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Image.asset(armRaise2,),
            ),
            const SizedBox(
              height: 10,
            ),
            const MyText(
              text: "Downward Facing Dog with Bent \nKnees",
