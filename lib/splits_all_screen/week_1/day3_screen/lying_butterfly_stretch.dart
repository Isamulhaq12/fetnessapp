...
class LyingButterflyStretch extends StatefulWidget {
  const LyingButterflyStretch({super.key});

  @override
  State<LyingButterflyStretch> createState() => _LyingButterflyStretchState();
}

class _LyingButterflyStretchState extends State<LyingButterflyStretch> {
  int min = 00;
  int second = 00;
