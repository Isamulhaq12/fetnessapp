...
class RelaxationPose extends StatefulWidget {
  const RelaxationPose({super.key});

  @override
  State<RelaxationPose> createState() => _RelaxationPoseState();
}

class _RelaxationPoseState extends State<RelaxationPose> {
  int min = 00;
  int second = 00;
