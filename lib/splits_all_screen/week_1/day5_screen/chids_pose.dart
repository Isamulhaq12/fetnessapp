...
class ChidsPoseScreen extends StatefulWidget {
  const ChidsPoseScreen({super.key});

  @override
  State<ChidsPoseScreen> createState() => _ChidsPoseScreenState();
}

class _ChidsPoseScreenState extends State<ChidsPoseScreen> {
  int min = 00;
  int second = 00;
