...
class CrescentLowLunge extends StatefulWidget {
  const CrescentLowLunge({super.key});

  @override
  State<CrescentLowLunge> createState() => _CrescentLowLungeState();
}

class _CrescentLowLungeState extends State<CrescentLowLunge> {
  int min = 00;
  int second = 00;
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Image.asset(crescentLowLung2),
            ),
            const SizedBox(
              height: 10,
            ),
