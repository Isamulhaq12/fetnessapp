...
import 'package:new_app/splits_all_screen/week_1/day5_screen/chids_pose.dart';
...
class _Day5ScreenState extends State<Day5Screen> {
  ...
  List<dynamic> day1 =[
    DayModel(
        upText: "Chid’s Pose",
        downText: "00:50",
        image: const AssetImage(chidPose),

    ),
    DayModel(
        upText: "Seated Side Bend Right",
        downText: "00:40",
        image: const AssetImage(seatedRight)
    ),
    DayModel(
    ...
    DayModel(
        upText: "Crescent Low Lunge with Arm\nExtended Up Left",
        downText: "00:60",
        image: const AssetImage(crescentLowLung)
    ),
    DayModel(
        upText: "",
        downText: "",
