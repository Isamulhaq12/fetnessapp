...
class SeatedRightScreen extends StatefulWidget {
  const SeatedRightScreen({super.key});

  @override
  State<SeatedRightScreen> createState() => _SeatedRightScreenState();
}

class _SeatedRightScreenState extends State<SeatedRightScreen> {
  int min = 00;
  int second = 00;
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Image.asset(seatedRight,),
            ),
            const SizedBox(
              height: 10,
            ),
            const MyText(
              text: "Seated Side Bend Right",
