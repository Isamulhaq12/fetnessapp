...
class StraightarmPlankScreen extends StatefulWidget {
  const StraightarmPlankScreen({super.key});

  @override
  State<StraightarmPlankScreen> createState() => _StraightarmPlankScreenState();
}

class _StraightarmPlankScreenState extends State<StraightarmPlankScreen> {
  int min = 00;
  int second = 00;
