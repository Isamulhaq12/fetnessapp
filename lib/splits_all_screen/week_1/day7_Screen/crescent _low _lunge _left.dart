...
class CrescentLeftScreen extends StatefulWidget {
  const CrescentLeftScreen({super.key});

  @override
  State<CrescentLeftScreen> createState() => _CrescentLeftScreenState();
}

class _CrescentLeftScreenState extends State<CrescentLeftScreen> {
  int min = 00;
  int second = 00;
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Image.asset(clll2, fit: BoxFit.cover),
            ),
            const SizedBox(
              height: 10,
            ),
            const MyText(
              text: "Crescent Low Lunge Left",
