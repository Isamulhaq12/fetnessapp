...
import 'package:new_app/splits_all_screen/week_1/day3_screen/lying_butterfly_stretch.dart';
import 'package:new_app/splits_all_screen/week_1/day3_screen/relaxation_pose.dart';
import 'package:new_app/splits_all_screen/week_1/day5_screen/crescent_low_lunge.dart';
import 'package:new_app/splits_all_screen/week_1/day6_screen/Straight-armPlank.dart';
import 'package:new_app/splits_all_screen/week_1/day6_screen/bridge.dart';
import 'package:new_app/splits_all_screen/week_1/day7_Screen/crescent%20_low%20_lunge%20_left.dart';
import 'package:new_app/splits_all_screen/week_1/day7_Screen/relaxation_pose.dart';
...
class _Day7ScreenState extends State<Day7Screen> {
          ...
          Padding(
            ...
            child: MyButton(
              ...
              circularRadius: BorderRadius.circular(25),
                ...
                onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => const RelaxationPoseScreen(),));
                },
                text: 'Start',
              fontSize: 18,
            ),
  ...
  List<dynamic> day1 =[
    ...
    DayModel(
        upText: "Crescent Low Lunge Left",
        downText: "00:40",
        image: const AssetImage(clll)
    ),
    DayModel(
        upText: "Lying Butterfly Stretch",
        downText: "00:30",
        image: const AssetImage(lyingButterfly)
    ),
    DayModel(
        upText: "Relaxation Pose",
        downText: "00:60",
        image: const AssetImage(relaxationPose)
    ),
    DayModel(
        upText: "",
        downText: "",
