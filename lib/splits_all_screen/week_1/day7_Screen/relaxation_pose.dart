...
class RelaxationPoseScreen extends StatefulWidget {
  const RelaxationPoseScreen({super.key});

  @override
  State<RelaxationPoseScreen> createState() => _RelaxationPoseScreenState();
}

class _RelaxationPoseScreenState extends State<RelaxationPoseScreen> {
  int min = 00;
  int second = 00;
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Image.asset(relaxationPose2,),
            ),
            const SizedBox(
              height: 10,
            ),
            const MyText(
              text: "Relaxation Pose",
